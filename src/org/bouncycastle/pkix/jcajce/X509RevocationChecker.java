...
public class X509RevocationChecker extends PKIXCertPathChecker {
  ...
  private static final Map<GeneralName, WeakReference<X509CRL>> crlCache = Collections.synchronizedMap(new WeakHashMap<GeneralName, WeakReference<X509CRL>>());
  ...
  private X509RevocationChecker(Builder paramBuilder) {
    this.crls = new ArrayList<Store<CRL>>(paramBuilder.crls);
    this.crlCertStores = new ArrayList<CertStore>(paramBuilder.crlCertStores);
  ...
  public void check(Certificate paramCertificate, Collection<String> paramCollection) throws CertPathValidatorException {
    ...
    try {
      ...
      if (cRL != null) {
        try {
          builder.addCRLStore(new LocalCRLStore((Store<CRL>)new CollectionStore(Collections.singleton(cRL))));
  ...
  public static class Builder {
    ...
    public Builder(Set<TrustAnchor> param1Set) {
      this.trustAnchors = new HashSet<TrustAnchor>(param1Set);
    }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/pkix/jcajce/X509RevocationChecker.class
