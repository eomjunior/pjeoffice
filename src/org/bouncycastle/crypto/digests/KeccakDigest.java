...
public class KeccakDigest implements ExtendedDigest {
  ...
  protected byte[] dumpState() {
    byte[] arrayOfByte = new byte[this.state.length * 8];
    boolean bool = false;
    for (byte b = 0; b != this.state.length; b++) {
      Pack.longToLittleEndian(this.state[b], arrayOfByte, bool);
      bool += true;
    } 
    return arrayOfByte;
  }
  ...
  private void KeccakAbsorb(byte[] paramArrayOfbyte, int paramInt) {
    ...
    String str = Hex.toHexString(dumpState()).toLowerCase();
    KeccakPermutation();
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/crypto/digests/KeccakDigest.class
