...
public class OpenBSDBCrypt {
  ...
  private static boolean doCheckPassword(String paramString, byte[] paramArrayOfbyte) {
    ...
    int k = (i == str3.length()) ? 1 : 0;
    for (int m = 0; m != i; m++)
      k &= (paramString.charAt(m) == str3.charAt(m)) ? 1 : 0; 
    return k;
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/crypto/generators/OpenBSDBCrypt.class
