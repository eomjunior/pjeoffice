...
public class PrivateKeyFactory {
  ...
  public static AsymmetricKeyParameter createKey(PrivateKeyInfo paramPrivateKeyInfo) throws IOException {
    ...
    if (aSN1ObjectIdentifier.equals((ASN1Primitive)EdECObjectIdentifiers.id_X25519))
      return (AsymmetricKeyParameter)new X25519PrivateKeyParameters(getRawKey(paramPrivateKeyInfo, 32), 0); 
    if (aSN1ObjectIdentifier.equals((ASN1Primitive)EdECObjectIdentifiers.id_X448))
      return (AsymmetricKeyParameter)new X448PrivateKeyParameters(getRawKey(paramPrivateKeyInfo, 56), 0); 
    if (aSN1ObjectIdentifier.equals((ASN1Primitive)EdECObjectIdentifiers.id_Ed25519))
      return (AsymmetricKeyParameter)new Ed25519PrivateKeyParameters(getRawKey(paramPrivateKeyInfo, 32), 0); 
    if (aSN1ObjectIdentifier.equals((ASN1Primitive)EdECObjectIdentifiers.id_Ed448))
      return (AsymmetricKeyParameter)new Ed448PrivateKeyParameters(getRawKey(paramPrivateKeyInfo, 57), 0); 
  ...
  private static byte[] getRawKey(PrivateKeyInfo paramPrivateKeyInfo, int paramInt) throws IOException {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/crypto/util/PrivateKeyFactory.class
