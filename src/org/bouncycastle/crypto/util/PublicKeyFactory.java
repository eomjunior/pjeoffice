...
public class PublicKeyFactory {
  ...
  private static byte[] getRawKey(SubjectPublicKeyInfo paramSubjectPublicKeyInfo, Object paramObject, int paramInt) {
  ...
  private static class ECConverter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      ...
      DERBitString dERBitString = param1SubjectPublicKeyInfo.getPublicKeyData();
  ...
  private static class Ed25519Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      return (AsymmetricKeyParameter)new Ed25519PublicKeyParameters(PublicKeyFactory.getRawKey(param1SubjectPublicKeyInfo, param1Object, 32), 0);
    }
  }
  ...
  private static class Ed448Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      return (AsymmetricKeyParameter)new Ed448PublicKeyParameters(PublicKeyFactory.getRawKey(param1SubjectPublicKeyInfo, param1Object, 57), 0);
    }
  }
  ...
  private static class X25519Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      return (AsymmetricKeyParameter)new X25519PublicKeyParameters(PublicKeyFactory.getRawKey(param1SubjectPublicKeyInfo, param1Object, 32), 0);
    }
  }
  ...
  private static class X448Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      return (AsymmetricKeyParameter)new X448PublicKeyParameters(PublicKeyFactory.getRawKey(param1SubjectPublicKeyInfo, param1Object, 56), 0);
    }
  }
}


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/crypto/util/PublicKeyFactory.class
