...
public class PrivateKeyInfoFactory {
  ...
  public static PrivateKeyInfo createPrivateKeyInfo(AsymmetricKeyParameter paramAsymmetricKeyParameter, ASN1Set paramASN1Set) throws IOException {
    ...
    if (paramAsymmetricKeyParameter instanceof ECPrivateKeyParameters) {
      ...
      return new PrivateKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, (ASN1Encodable)x962Parameters), (ASN1Encodable)new ECPrivateKey(i, eCPrivateKeyParameters.getD(), dERBitString, (ASN1Encodable)x962Parameters), paramASN1Set);
    } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/crypto/util/PrivateKeyInfoFactory.class
