  ...
  public static AsymmetricKeyParameter parsePrivateKeyBlob(byte[] paramArrayOfbyte) {
    ...
    if (paramArrayOfbyte[0] == 48) {
      ...
      if (aSN1Sequence.size() == 6) {
        ...
        eCPrivateKeyParameters = new ECPrivateKeyParameters(eCPrivateKey.getKey(), (ECDomainParameters)new ECNamedDomainParameters(aSN1ObjectIdentifier, x9ECParameters));
      } 
    } else {
      ...
      if ("ssh-ed25519".equals(str2)) {
        ...
        sSHBuffer2.readBlock();
        byte[] arrayOfByte1 = sSHBuffer2.readBlock();
        eCPrivateKeyParameters = new ECPrivateKeyParameters(new BigInteger(1, arrayOfByte1), (ECDomainParameters)new ECNamedDomainParameters(aSN1ObjectIdentifier, x9ECParameters));
      } 
    ...
    return (AsymmetricKeyParameter)eCPrivateKeyParameters;
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/crypto/util/OpenSSHPrivateKeyUtil.class
