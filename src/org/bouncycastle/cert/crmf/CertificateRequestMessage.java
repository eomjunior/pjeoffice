...
public class CertificateRequestMessage implements Encodable {
  ...
  private boolean verifySignature(ContentVerifierProvider paramContentVerifierProvider, POPOSigningKey paramPOPOSigningKey) throws CRMFException {
    ...
    if (paramPOPOSigningKey.getPoposkInput() != null) {
      CRMFUtil.derEncodeToStream((ASN1Object)paramPOPOSigningKey.getPoposkInput(), contentVerifier.getOutputStream());
    } else {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/cert/crmf/CertificateRequestMessage.class
