...
public class EncryptedValueBuilder {
  ...
  public EncryptedValue build(PrivateKeyInfo paramPrivateKeyInfo) throws CRMFException {
    ...
    try {
      ...
      return new EncryptedValue(algorithmIdentifier1, algorithmIdentifier2, dERBitString, algorithmIdentifier, aSN1OctetString, new DERBitString(pKCS8EncryptedPrivateKeyInfo.getEncryptedData()));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/cert/crmf/EncryptedValueBuilder.class
