...
class PKMACValueVerifier {
  ...
  public boolean isValid(PKMACValue paramPKMACValue, char[] paramArrayOfchar, SubjectPublicKeyInfo paramSubjectPublicKeyInfo) throws CRMFException {
    ...
    return Arrays.constantTimeAreEqual(macCalculator.getMac(), paramPKMACValue.getValue().getBytes());
  }
}


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/cert/crmf/PKMACValueVerifier.class
