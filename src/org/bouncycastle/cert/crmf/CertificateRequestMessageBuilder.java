...
public class CertificateRequestMessageBuilder {
  ...
  public CertificateRequestMessage build() throws CRMFException {
    ...
    if (this.popSigner != null) {
      ...
      aSN1EncodableVector.add((ASN1Encodable)new ProofOfPossession(this.popoType, this.popoPrivKey));
    } else if (this.agreeMAC != null) {
      aSN1EncodableVector.add((ASN1Encodable)new ProofOfPossession(3, POPOPrivKey.getInstance(new DERTaggedObject(false, 3, (ASN1Encodable)this.agreeMAC))));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/cert/crmf/CertificateRequestMessageBuilder.class
