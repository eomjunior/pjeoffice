...
public class EACCertificateBuilder {
  ...
  private CertificateBody buildBody() {
    ...
    return new CertificateBody((ASN1ApplicationSpecific)dERApplicationSpecific, this.certificationAuthorityReference, this.publicKey, this.certificateHolderReference, this.certificateHolderAuthorization, this.certificateEffectiveDate, this.certificateExpirationDate);
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/eac/EACCertificateBuilder.class
