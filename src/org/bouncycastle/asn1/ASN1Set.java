...
public abstract class ASN1Set extends ASN1Primitive implements Iterable<ASN1Encodable> {
  ...
  public static ASN1Set getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    ...
    if (paramASN1TaggedObject.isExplicit())
      return (ASN1Set)((paramASN1TaggedObject instanceof BERTaggedObject) ? new BERSet(aSN1Primitive) : new DLSet(aSN1Primitive)); 
    if (aSN1Primitive instanceof ASN1Set) {
      ASN1Set aSN1Set = (ASN1Set)aSN1Primitive;
      return (paramASN1TaggedObject instanceof BERTaggedObject) ? aSN1Set : (ASN1Set)aSN1Set.toDLObject();
    } 
    if (aSN1Primitive instanceof ASN1Sequence) {
      ASN1Sequence aSN1Sequence = (ASN1Sequence)aSN1Primitive;
      ASN1Encodable[] arrayOfASN1Encodable = aSN1Sequence.toArrayInternal();
      return (ASN1Set)((paramASN1TaggedObject instanceof BERTaggedObject) ? new BERSet(false, arrayOfASN1Encodable) : new DLSet(false, arrayOfASN1Encodable));
    } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/ASN1Set.class
