...
public class ASN1UTCTime extends ASN1Primitive {
  ...
  public static ASN1UTCTime getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    ...
    return (paramBoolean || aSN1Primitive instanceof ASN1UTCTime) ? getInstance(aSN1Primitive) : new ASN1UTCTime(ASN1OctetString.getInstance(aSN1Primitive).getOctets());
  }
  ...
  void encode(ASN1OutputStream paramASN1OutputStream, boolean paramBoolean) throws IOException {
    paramASN1OutputStream.writeEncoded(paramBoolean, 23, this.time);
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/ASN1UTCTime.class
