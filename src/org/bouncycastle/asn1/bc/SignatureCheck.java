...
public class SignatureCheck extends ASN1Object {
  ...
  private SignatureCheck(ASN1Sequence paramASN1Sequence) {
    ...
    this.signatureValue = (ASN1BitString)DERBitString.getInstance(paramASN1Sequence.getObjectAt(b));
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/bc/SignatureCheck.class
