...
public abstract class ASN1OctetString extends ASN1Primitive implements ASN1OctetStringParser {
  ...
  public static ASN1OctetString getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    ...
    if (paramASN1TaggedObject.isExplicit()) {
      ...
      return (paramASN1TaggedObject instanceof BERTaggedObject) ? new BEROctetString(new ASN1OctetString[] { aSN1OctetString }) : (ASN1OctetString)(new BEROctetString(new ASN1OctetString[] { aSN1OctetString })).toDLObject();
    } 
    if (aSN1Primitive instanceof ASN1OctetString) {
      ASN1OctetString aSN1OctetString = (ASN1OctetString)aSN1Primitive;
      return (paramASN1TaggedObject instanceof BERTaggedObject) ? aSN1OctetString : (ASN1OctetString)aSN1OctetString.toDLObject();
    } 
    if (aSN1Primitive instanceof ASN1Sequence) {
      ASN1Sequence aSN1Sequence = (ASN1Sequence)aSN1Primitive;
      return (paramASN1TaggedObject instanceof BERTaggedObject) ? BEROctetString.fromSequence(aSN1Sequence) : (ASN1OctetString)BEROctetString.fromSequence(aSN1Sequence).toDLObject();
    } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/ASN1OctetString.class
