...
class DefiniteLengthInputStream extends LimitedInputStream {
  ...
  void readAllIntoByteArray(byte[] paramArrayOfbyte) throws IOException {
    ...
    if ((this._remaining -= Streams.readFully(this._in, paramArrayOfbyte)) != 0)
      throw new EOFException("DEF length " + this._originalLength + " object truncated by " + this._remaining); 
    setParentEofDetect(true);
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/DefiniteLengthInputStream.class
