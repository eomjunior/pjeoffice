...
public abstract class ASN1Sequence extends ASN1Primitive implements Iterable<ASN1Encodable> {
  ...
  public static ASN1Sequence getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    ...
    if (paramASN1TaggedObject.isExplicit())
      return (ASN1Sequence)((paramASN1TaggedObject instanceof BERTaggedObject) ? new BERSequence(aSN1Primitive) : new DLSequence(aSN1Primitive)); 
    if (aSN1Primitive instanceof ASN1Sequence) {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/ASN1Sequence.class
