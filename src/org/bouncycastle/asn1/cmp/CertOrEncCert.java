...
public class CertOrEncCert extends ASN1Object implements ASN1Choice {
  ...
  private CertOrEncCert(ASN1TaggedObject paramASN1TaggedObject) {
    if (paramASN1TaggedObject.getTagNo() == 0) {
      ...
      this.encryptedKey = EncryptedKey.getInstance(paramASN1TaggedObject.getObject());
    } else {
  ...
  public CertOrEncCert(EncryptedValue paramEncryptedValue) {
    ...
    this.encryptedKey = new EncryptedKey(paramEncryptedValue);
  }
  ...
  public CertOrEncCert(EncryptedKey paramEncryptedKey) {
    ...
    this.encryptedKey = paramEncryptedKey;
  }
  ...
  public ASN1Primitive toASN1Primitive() {
    return (ASN1Primitive)((this.certificate != null) ? new DERTaggedObject(true, 0, (ASN1Encodable)this.certificate) : new DERTaggedObject(true, 1, (ASN1Encodable)this.encryptedKey));
  }
}


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/cmp/CertOrEncCert.class
