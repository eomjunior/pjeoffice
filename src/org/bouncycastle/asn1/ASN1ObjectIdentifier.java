...
public class ASN1ObjectIdentifier extends ASN1Primitive {
  ...
  public static ASN1ObjectIdentifier getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    ...
    return (paramBoolean || aSN1Primitive instanceof ASN1ObjectIdentifier) ? getInstance(aSN1Primitive) : fromOctetString(ASN1OctetString.getInstance(aSN1Primitive).getOctets());
  }
  ...
  void encode(ASN1OutputStream paramASN1OutputStream, boolean paramBoolean) throws IOException {
    paramASN1OutputStream.writeEncoded(paramBoolean, 6, getBody());
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/ASN1ObjectIdentifier.class
