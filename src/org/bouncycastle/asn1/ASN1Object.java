...
public abstract class ASN1Object implements ASN1Encodable, Encodable {
  public void encodeTo(OutputStream paramOutputStream) throws IOException {
    ASN1OutputStream.create(paramOutputStream).writeObject(this);
  }
  
  public void encodeTo(OutputStream paramOutputStream, String paramString) throws IOException {
    ASN1OutputStream.create(paramOutputStream, paramString).writeObject(this);
  }
  ...
  public byte[] getEncoded(String paramString) throws IOException {
    ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
    encodeTo(byteArrayOutputStream, paramString);
    return byteArrayOutputStream.toByteArray();
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/ASN1Object.class
