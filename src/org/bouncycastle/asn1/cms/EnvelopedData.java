  ...
  public static int calculateVersion(OriginatorInfo paramOriginatorInfo, ASN1Set paramASN1Set1, ASN1Set paramASN1Set2) {
    ...
    if (paramOriginatorInfo != null || paramASN1Set2 != null) {
      ...
      while (enumeration.hasMoreElements()) {
        ...
        if (recipientInfo.getVersion().intValueExact() != b) {
          b = 2;
          break;
        } 
      } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/cms/EnvelopedData.class
