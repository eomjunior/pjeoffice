...
public class DLApplicationSpecific extends ASN1ApplicationSpecific {
  ...
  private static byte[] getEncoding(boolean paramBoolean, ASN1Encodable paramASN1Encodable) throws IOException {
    byte[] arrayOfByte1 = paramASN1Encodable.toASN1Primitive().getEncoded("DL");
    if (paramBoolean)
      return arrayOfByte1; 
  ...
  private static byte[] getEncodedVector(ASN1EncodableVector paramASN1EncodableVector) {
    ...
    for (byte b = 0; b != paramASN1EncodableVector.size(); b++) {
      try {
        byteArrayOutputStream.write(((ASN1Object)paramASN1EncodableVector.get(b)).getEncoded("DL"));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/DLApplicationSpecific.class
