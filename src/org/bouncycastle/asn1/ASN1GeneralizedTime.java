...
public class ASN1GeneralizedTime extends ASN1Primitive {
  ...
  public static ASN1GeneralizedTime getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    ...
    return (paramBoolean || aSN1Primitive instanceof ASN1GeneralizedTime) ? getInstance(aSN1Primitive) : new ASN1GeneralizedTime(ASN1OctetString.getInstance(aSN1Primitive).getOctets());
  }
  ...
  private boolean isDigit(int paramInt) {
    return (this.time.length > paramInt && this.time[paramInt] >= 48 && this.time[paramInt] <= 57);
  }
  ...
  void encode(ASN1OutputStream paramASN1OutputStream, boolean paramBoolean) throws IOException {
    paramASN1OutputStream.writeEncoded(paramBoolean, 24, this.time);
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/ASN1GeneralizedTime.class
