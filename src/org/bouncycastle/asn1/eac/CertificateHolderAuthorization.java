...
public class CertificateHolderAuthorization extends ASN1Object {
  ...
  public CertificateHolderAuthorization(ASN1ApplicationSpecific paramASN1ApplicationSpecific) throws IOException {
    if (paramASN1ApplicationSpecific.getApplicationTag() == 76)
      setPrivateData(new ASN1InputStream(paramASN1ApplicationSpecific.getContents())); 
  }
  ...
  private void setAccessRights(byte paramByte) {
    ...
    this.accessRights = (ASN1ApplicationSpecific)new DERApplicationSpecific(19, arrayOfByte);
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/eac/CertificateHolderAuthorization.class
