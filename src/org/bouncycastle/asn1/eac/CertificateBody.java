...
public class CertificateBody extends ASN1Object {
  ...
  public CertificateBody(ASN1ApplicationSpecific paramASN1ApplicationSpecific, CertificationAuthorityReference paramCertificationAuthorityReference, PublicKeyDataObject paramPublicKeyDataObject, CertificateHolderReference paramCertificateHolderReference, CertificateHolderAuthorization paramCertificateHolderAuthorization, PackedDate paramPackedDate1, PackedDate paramPackedDate2) {
    ...
    setCertificationAuthorityReference((ASN1ApplicationSpecific)new DERApplicationSpecific(2, paramCertificationAuthorityReference.getEncoded()));
    setPublicKey(paramPublicKeyDataObject);
    setCertificateHolderReference((ASN1ApplicationSpecific)new DERApplicationSpecific(32, paramCertificateHolderReference.getEncoded()));
    setCertificateHolderAuthorization(paramCertificateHolderAuthorization);
    try {
      setCertificateEffectiveDate((ASN1ApplicationSpecific)new DERApplicationSpecific(false, 37, (ASN1Encodable)new DEROctetString(paramPackedDate1.getEncoding())));
      setCertificateExpirationDate((ASN1ApplicationSpecific)new DERApplicationSpecific(false, 36, (ASN1Encodable)new DEROctetString(paramPackedDate2.getEncoding())));
  ...
  private void setCertificateProfileIdentifier(ASN1ApplicationSpecific paramASN1ApplicationSpecific) throws IllegalArgumentException {
  ...
  private void setCertificateHolderReference(ASN1ApplicationSpecific paramASN1ApplicationSpecific) throws IllegalArgumentException {
  ...
  private void setCertificationAuthorityReference(ASN1ApplicationSpecific paramASN1ApplicationSpecific) throws IllegalArgumentException {
  ...
  private void setCertificateEffectiveDate(ASN1ApplicationSpecific paramASN1ApplicationSpecific) throws IllegalArgumentException {
  ...
  private void setCertificateExpirationDate(ASN1ApplicationSpecific paramASN1ApplicationSpecific) throws IllegalArgumentException {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/eac/CertificateBody.class
