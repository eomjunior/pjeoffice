...
public class CVCertificate extends ASN1Object {
        ...
        if (aSN1Primitive instanceof ASN1ApplicationSpecific) {
          ...
          switch (aSN1ApplicationSpecific.getApplicationTag()) {
            case 78:
              ...
              continue;
            case 55:
              this.signature = aSN1ApplicationSpecific.getContents();
              this.valid |= signValid;
              continue;
          } 
          throw new IOException("Invalid tag, not an Iso7816CertificateStructure :" + aSN1ApplicationSpecific.getApplicationTag());
        } 
  ...
  public static CVCertificate getInstance(Object paramObject) {
    ...
    if (paramObject != null)
      try {
        return new CVCertificate(ASN1ApplicationSpecific.getInstance(paramObject));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/eac/CVCertificate.class
