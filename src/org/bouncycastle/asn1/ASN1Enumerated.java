...
public class ASN1Enumerated extends ASN1Primitive {
  ...
  public static ASN1Enumerated getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    ...
    return (paramBoolean || aSN1Primitive instanceof ASN1Enumerated) ? getInstance(aSN1Primitive) : fromOctetString(ASN1OctetString.getInstance(aSN1Primitive).getOctets());
  }
  ...
  public boolean hasValue(BigInteger paramBigInteger) {
    return (null != paramBigInteger && ASN1Integer.intValue(this.bytes, this.start, -1) == paramBigInteger.intValue() && getValue().equals(paramBigInteger));
  }
  ...
  void encode(ASN1OutputStream paramASN1OutputStream, boolean paramBoolean) throws IOException {
    paramASN1OutputStream.writeEncoded(paramBoolean, 10, this.bytes);
  }
  ...
  static ASN1Enumerated fromOctetString(byte[] paramArrayOfbyte) {
    ...
    if (aSN1Enumerated == null)
      aSN1Enumerated = cache[i] = new ASN1Enumerated(paramArrayOfbyte); 
    return aSN1Enumerated;
  }
}


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/ASN1Enumerated.class
