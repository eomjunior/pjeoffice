...
public class ASN1StreamParser {
  ...
  ASN1Primitive readTaggedObject(boolean paramBoolean, int paramInt) throws IOException {
    ...
    return (this._in instanceof IndefiniteLengthInputStream) ? ((aSN1EncodableVector.size() == 1) ? new BERTaggedObject(true, paramInt, aSN1EncodableVector.get(0)) : new BERTaggedObject(false, paramInt, BERFactory.createSequence(aSN1EncodableVector))) : ((aSN1EncodableVector.size() == 1) ? new DLTaggedObject(true, paramInt, aSN1EncodableVector.get(0)) : new DLTaggedObject(false, paramInt, DLFactory.createSequence(aSN1EncodableVector)));
  }
  ...
  ASN1EncodableVector readVector() throws IOException {
    ...
    while (true) {
      ...
      if ((aSN1Encodable = readObject()) == null)
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/ASN1StreamParser.class
