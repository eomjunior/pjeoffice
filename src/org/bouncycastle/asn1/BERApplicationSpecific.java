...
public class BERApplicationSpecific extends ASN1ApplicationSpecific {
  ...
  void encode(ASN1OutputStream paramASN1OutputStream, boolean paramBoolean) throws IOException {
    ...
    if (this.isConstructed)
      i |= 0x20; 
    paramASN1OutputStream.writeEncodedIndef(paramBoolean, i, this.tag, this.octets);
  }
}


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/BERApplicationSpecific.class
