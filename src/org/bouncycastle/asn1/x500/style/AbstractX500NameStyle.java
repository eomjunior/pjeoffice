...
public abstract class AbstractX500NameStyle implements X500NameStyle {
  ...
  public boolean areEqual(X500Name paramX500Name1, X500Name paramX500Name2) {
    ...
    if (arrayOfRDN1[0].getFirst() != null && arrayOfRDN2[0].getFirst() != null)
      bool = !arrayOfRDN1[0].getFirst().getType().equals((ASN1Primitive)arrayOfRDN2[0].getFirst().getType()) ? true : false; 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/asn1/x500/style/AbstractX500NameStyle.class
