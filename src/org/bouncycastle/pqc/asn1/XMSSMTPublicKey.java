...
public class XMSSMTPublicKey extends ASN1Object {
  ...
  private XMSSMTPublicKey(ASN1Sequence paramASN1Sequence) {
    if (!ASN1Integer.getInstance(paramASN1Sequence.getObjectAt(0)).hasValue(BigInteger.valueOf(0L)))
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/pqc/asn1/XMSSMTPublicKey.class
