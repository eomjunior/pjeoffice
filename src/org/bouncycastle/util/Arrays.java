...
public final class Arrays {
  ...
  public static void fill(byte[] paramArrayOfbyte, int paramInt, byte paramByte) {
    fill(paramArrayOfbyte, paramInt, paramArrayOfbyte.length, paramByte);
  }
  ...
  public static void fill(int[] paramArrayOfint, int paramInt1, int paramInt2) {
    java.util.Arrays.fill(paramArrayOfint, paramInt1, paramArrayOfint.length, paramInt2);
  }
  ...
  public static void fill(long[] paramArrayOflong, int paramInt, long paramLong) {
    java.util.Arrays.fill(paramArrayOflong, paramInt, paramArrayOflong.length, paramLong);
  }
  ...
  public static void fill(short[] paramArrayOfshort, int paramInt, short paramShort) {
    java.util.Arrays.fill(paramArrayOfshort, paramInt, paramArrayOfshort.length, paramShort);
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/util/Arrays.class
