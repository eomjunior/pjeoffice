...
public class CompositePublicKey implements PublicKey {
  ...
  public byte[] getEncoded() {
    ...
    try {
      return (new SubjectPublicKeyInfo(new AlgorithmIdentifier(MiscObjectIdentifiers.id_alg_composite), (ASN1Encodable)new DERSequence(aSN1EncodableVector))).getEncoded("DER");
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/CompositePublicKey.class
