...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
  ...
  public boolean equals(Object paramObject) {
    ...
    if (paramObject instanceof X509CertificateObject) {
      ...
      if (this.hashValueSet && x509CertificateObject.hashValueSet) {
        ...
        if (null != dERBitString && !dERBitString.equals((ASN1Primitive)x509CertificateObject.c.getSignature()))
          return false; 
      } 
    } 
  ...
  private X509CertificateInternal getInternalCertificate() {
    ...
    X509CertificateInternal x509CertificateInternal = new X509CertificateInternal(this.bcHelper, this.c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, arrayOfByte);
    synchronized (this.cacheLock) {
      if (null == this.internalCertificateValue)
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject.class
