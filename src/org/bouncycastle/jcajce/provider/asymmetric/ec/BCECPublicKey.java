...
public class BCECPublicKey implements ECPublicKey, ECPublicKey, ECPointEncoder {
  ...
  public byte[] getEncoded() {
    ...
    AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, (ASN1Encodable)ECUtils.getDomainParametersFromName(this.ecSpec, bool));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey.class
