  ...
  public static class EC extends KeyPairGeneratorSpi {
    ...
    protected ECKeyGenerationParameters createKeyGenParamsJCE(ECParameterSpec param1ECParameterSpec, SecureRandom param1SecureRandom) {
      if (param1ECParameterSpec instanceof ECNamedCurveSpec) {
        X9ECParameters x9ECParameters = ECUtils.getDomainParametersFromName(((ECNamedCurveSpec)param1ECParameterSpec).getName());
        if (x9ECParameters != null) {
          ECDomainParameters eCDomainParameters1 = new ECDomainParameters(x9ECParameters.getCurve(), x9ECParameters.getG(), x9ECParameters.getN(), x9ECParameters.getH());
          return new ECKeyGenerationParameters(eCDomainParameters1, param1SecureRandom);
        } 
      } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/asymmetric/ec/KeyPairGeneratorSpi.class
