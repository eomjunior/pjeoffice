...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
  ...
  protected KeySpec engineGetKeySpec(Key paramKey, Class paramClass) throws InvalidKeySpecException {
    if (paramClass.isAssignableFrom(OpenSSHPrivateKeySpec.class) && paramKey instanceof BCEdDSAPrivateKey)
      try {
        ...
        return (KeySpec)new OpenSSHPrivateKeySpec(OpenSSHPrivateKeyUtil.encodePrivateKey((AsymmetricKeyParameter)new Ed25519PrivateKeyParameters(ASN1OctetString.getInstance(aSN1InputStream.readObject()).getOctets(), 0)));
    ...
    if (paramClass.isAssignableFrom(OpenSSHPublicKeySpec.class) && paramKey instanceof BCEdDSAPublicKey)
      try {
        return (KeySpec)new OpenSSHPublicKeySpec(OpenSSHPublicKeyUtil.encodePublicKey((AsymmetricKeyParameter)new Ed25519PublicKeyParameters(paramKey.getEncoded(), Ed25519Prefix.length)));
      } catch (IOException iOException) {
        throw new InvalidKeySpecException(iOException.getMessage(), iOException.getCause());
      }  
    if (paramClass.isAssignableFrom(OpenSSHPrivateKeySpec.class) && paramKey instanceof BCEdDSAPrivateKey)
  ...
  protected PublicKey engineGeneratePublic(KeySpec paramKeySpec) throws InvalidKeySpecException {
    ...
    } else if (paramKeySpec instanceof OpenSSHPublicKeySpec) {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/asymmetric/edec/KeyFactorySpi.class
