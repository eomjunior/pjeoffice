  ...
  protected void engineInit(int paramInt, Key paramKey, AlgorithmParameterSpec paramAlgorithmParameterSpec, SecureRandom paramSecureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
    ...
    if (!(this.cipher instanceof RSABlindedEngine))
      if (paramSecureRandom != null) {
        ...
        parametersWithRandom = new ParametersWithRandom((CipherParameters)parametersWithRandom, CryptoServicesRegistrar.getSecureRandom());
      }  
    this.bOut.reset();
    switch (paramInt) {
      case 1:
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/asymmetric/rsa/CipherSpi.class
