...
public class RSA {
  ...
  public static class Mappings extends AsymmetricAlgorithmProvider {
    ...
    private void addPSSSignature(ConfigurableProvider param1ConfigurableProvider, String param1String1, String param1String2) {
      ...
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WithRSAAndMGF1", param1String1 + "WITHRSAANDMGF1");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "withRSASSA-PSS", param1String1 + "WITHRSAANDMGF1");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WithRSASSA-PSS", param1String1 + "WITHRSAANDMGF1");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WITHRSASSA-PSS", param1String1 + "WITHRSAANDMGF1");
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/asymmetric/RSA.class
