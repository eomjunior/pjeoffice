    ...
    try {
      ...
      if (aSN1Sequence.size() == 1) {
        ...
        if (aSN1TaggedObject.getTagNo() == 0) {
          this.currentSpec = new IESParameterSpec(ASN1OctetString.getInstance(aSN1TaggedObject, false).getOctets(), null, ASN1Integer.getInstance(aSN1Sequence.getObjectAt(1)).intValueExact());
        } else {
          this.currentSpec = new IESParameterSpec(null, ASN1OctetString.getInstance(aSN1TaggedObject, false).getOctets(), ASN1Integer.getInstance(aSN1Sequence.getObjectAt(1)).intValueExact());
        } 
        ...
        this.currentSpec = new IESParameterSpec(ASN1OctetString.getInstance(aSN1TaggedObject1, false).getOctets(), ASN1OctetString.getInstance(aSN1TaggedObject2, false).getOctets(), ASN1Integer.getInstance(aSN1Sequence.getObjectAt(2)).intValueExact());
      } else if (aSN1Sequence.size() == 4) {
        ASN1TaggedObject aSN1TaggedObject1 = ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(0));
        ASN1TaggedObject aSN1TaggedObject2 = ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(1));
        ASN1Sequence aSN1Sequence1 = ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(3));
        this.currentSpec = new IESParameterSpec(ASN1OctetString.getInstance(aSN1TaggedObject1, false).getOctets(), ASN1OctetString.getInstance(aSN1TaggedObject2, false).getOctets(), ASN1Integer.getInstance(aSN1Sequence.getObjectAt(2)).intValueExact(), ASN1Integer.getInstance(aSN1Sequence1.getObjectAt(0)).intValueExact(), ASN1OctetString.getInstance(aSN1Sequence1.getObjectAt(1)).getOctets());
      } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/asymmetric/ies/AlgorithmParametersSpi.class
