...
public class SHA3 {
  ...
  public static class DigestSHAKE extends BCMessageDigest implements Cloneable {
    public DigestSHAKE(int param1Int1, int param1Int2) {
      super((Xof)new SHAKEDigest(param1Int1), param1Int2);
    }
    
    public byte[] engineDigest() {
      byte[] arrayOfByte = new byte[this.digestSize];
      ((Xof)this.digest).doFinal(arrayOfByte, 0, this.digestSize);
      return arrayOfByte;
    }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/digest/SHA3.class
