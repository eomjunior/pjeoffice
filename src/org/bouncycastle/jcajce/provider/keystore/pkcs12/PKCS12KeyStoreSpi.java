...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
  ...
  public void engineLoad(InputStream paramInputStream, char[] paramArrayOfchar) throws IOException {
    ...
    } else if (paramArrayOfchar != null && !Properties.isOverrideSet("org.bouncycastle.pkcs12.ignore_useless_passwd")) {
  ...
  private SafeBag createSafeBag(String paramString, Certificate paramCertificate) throws CertificateEncodingException {
    ...
    if (paramCertificate instanceof PKCS12BagAttributeCarrier) {
      ...
      DERBMPString dERBMPString = (DERBMPString)pKCS12BagAttributeCarrier.getBagAttribute(pkcs_9_at_friendlyName);
      if ((dERBMPString == null || !dERBMPString.getString().equals(paramString)) && paramString != null)
  ...
  public static class BCPKCS12KeyStore extends PKCS12KeyStoreSpi {
    public BCPKCS12KeyStore() {
      super((JcaJceHelper)new BCJcaJceHelper(), pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd40BitRC2_CBC);
    }
  }
  
  public static class BCPKCS12KeyStore3DES extends PKCS12KeyStoreSpi {
    public BCPKCS12KeyStore3DES() {
      super((JcaJceHelper)new BCJcaJceHelper(), pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd3_KeyTripleDES_CBC);
    }
  }
  ...
  public static class DefPKCS12KeyStore extends PKCS12KeyStoreSpi {
    public DefPKCS12KeyStore() {
      super((JcaJceHelper)new DefaultJcaJceHelper(), pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd40BitRC2_CBC);
    }
  }
  
  public static class DefPKCS12KeyStore3DES extends PKCS12KeyStoreSpi {
    public DefPKCS12KeyStore3DES() {
      super((JcaJceHelper)new DefaultJcaJceHelper(), pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd3_KeyTripleDES_CBC);
    }
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi.class
