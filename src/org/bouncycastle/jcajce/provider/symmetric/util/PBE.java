    ...
    private static PBEParametersGenerator makePBEGenerator(int param1Int1, int param1Int2) {
      ...
      if (param1Int1 == 1 || param1Int1 == 5) {
        switch (param1Int2) {
          ...
          case 14:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator((Digest)new SM3Digest());
        } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/symmetric/util/PBE.class
