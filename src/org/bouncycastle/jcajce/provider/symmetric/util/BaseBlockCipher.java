  ...
  protected void engineSetMode(String paramString) throws NoSuchAlgorithmException {
    ...
    if (this.modeName.equals("ECB")) {
      ...
      if (this.baseEngine instanceof org.bouncycastle.crypto.engines.DSTU7624Engine) {
        ...
        this.cipher = new AEADGenericBlockCipher((AEADCipher)new CCMBlockCipher(this.baseEngine));
      } 
      ...
      if (this.baseEngine instanceof org.bouncycastle.crypto.engines.DSTU7624Engine) {
        ...
        this.cipher = new AEADGenericBlockCipher((AEADCipher)new GCMBlockCipher(this.baseEngine));
      } 
    } else {
      throw new NoSuchAlgorithmException("can't support mode " + paramString);
    } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher.class
