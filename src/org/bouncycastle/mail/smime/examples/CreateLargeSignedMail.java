...
public class CreateLargeSignedMail {
  ...
  static X509Certificate makeCertificate(KeyPair paramKeyPair1, String paramString1, KeyPair paramKeyPair2, String paramString2) throws GeneralSecurityException, IOException, OperatorCreationException {
    ...
    jcaX509v3CertificateBuilder.addExtension(Extension.subjectKeyIdentifier, false, (ASN1Encodable)jcaX509ExtensionUtils.createSubjectKeyIdentifier(publicKey1));
  ...
  public static void main(String[] paramArrayOfString) throws Exception {
    ...
    mimeBodyPart.setDataHandler(new DataHandler((DataSource)new FileDataSource(new File(paramArrayOfString[0]))));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/examples/CreateLargeSignedMail.class
