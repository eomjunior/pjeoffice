...
public class SendSignedAndEncryptedMail {
  public static void main(String[] paramArrayOfString) {
    ...
    try {
      ...
      mimeMessage1.setFrom((Address)new InternetAddress(paramArrayOfString[4]));
      mimeMessage1.setRecipient(Message.RecipientType.TO, (Address)new InternetAddress(paramArrayOfString[4]));
      ...
      aSN1EncodableVector.add((ASN1Encodable)new SMIMEEncryptionKeyPreferenceAttribute(new IssuerAndSerialNumber(new X500Name(((X509Certificate)arrayOfCertificate[0]).getIssuerDN().getName()), ((X509Certificate)arrayOfCertificate[0]).getSerialNumber())));
      ...
      Enumeration<String> enumeration = mimeMessage1.getAllHeaderLines();
      while (enumeration.hasMoreElements())
        mimeMessage2.addHeaderLine(enumeration.nextElement()); 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/examples/SendSignedAndEncryptedMail.class
