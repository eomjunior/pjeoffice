...
public class CreateSignedMail {
  ...
  static AuthorityKeyIdentifier createAuthorityKeyId(PublicKey paramPublicKey) throws IOException {
  ...
  static SubjectKeyIdentifier createSubjectKeyId(PublicKey paramPublicKey) throws IOException {
    SubjectPublicKeyInfo subjectPublicKeyInfo = SubjectPublicKeyInfo.getInstance(paramPublicKey.getEncoded());
  ...
  static X509Certificate makeCertificate(KeyPair paramKeyPair1, String paramString1, KeyPair paramKeyPair2, String paramString2) throws GeneralSecurityException, IOException, OperatorCreationException {
    ...
    jcaX509v3CertificateBuilder.addExtension(X509Extension.subjectKeyIdentifier, false, (ASN1Encodable)createSubjectKeyId(publicKey1));
  ...
  public static void main(String[] paramArrayOfString) throws Exception {
    ...
    MimeMultipart mimeMultipart = sMIMESignedGenerator.generate(mimeBodyPart);
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/examples/CreateSignedMail.class
