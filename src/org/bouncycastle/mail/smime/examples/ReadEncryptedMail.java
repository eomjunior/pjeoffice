...
public class ReadEncryptedMail {
  public static void main(String[] paramArrayOfString) throws Exception {
    ...
    MimeBodyPart mimeBodyPart = SMIMEUtil.toMimeBodyPart(recipientInformation.getContent((Recipient)(new JceKeyTransEnvelopedRecipient((PrivateKey)keyStore.getKey(str, null))).setProvider("BC")));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/examples/ReadEncryptedMail.class
