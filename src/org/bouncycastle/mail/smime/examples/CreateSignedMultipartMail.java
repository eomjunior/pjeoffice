...
public class CreateSignedMultipartMail {
  ...
  static X509Certificate makeCertificate(KeyPair paramKeyPair1, String paramString1, KeyPair paramKeyPair2, String paramString2) throws GeneralSecurityException, IOException, OperatorCreationException {
    ...
    jcaX509v3CertificateBuilder.addExtension(X509Extension.subjectKeyIdentifier, false, (ASN1Encodable)jcaX509ExtensionUtils.createSubjectKeyIdentifier(publicKey1));
    jcaX509v3CertificateBuilder.addExtension(X509Extension.authorityKeyIdentifier, false, (ASN1Encodable)jcaX509ExtensionUtils.createAuthorityKeyIdentifier(publicKey2));
  ...
  public static void main(String[] paramArrayOfString) throws Exception {
    ...
    mimeBodyPart3.setContent((Multipart)mimeMultipart1);
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/examples/CreateSignedMultipartMail.class
