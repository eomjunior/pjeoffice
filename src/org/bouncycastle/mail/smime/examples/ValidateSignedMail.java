    ...
    for (SignerInformation signerInformation : signedMailValidator.getSignerInformationStore().getSigners()) {
      ...
      if (pKIXCertPathReviewer != null) {
        ...
        for (ErrorBundle errorBundle : pKIXCertPathReviewer.getNotifications(-1))
          System.out.println("\t" + errorBundle.getText(locale)); 
        Iterator<? extends Certificate> iterator = pKIXCertPathReviewer.getCertPath().getCertificates().iterator();
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/examples/ValidateSignedMail.class
