...
public class SMIMESigned extends CMSSignedData {
  ...
  public SMIMESigned(MimeMultipart paramMimeMultipart) throws MessagingException, CMSException {
    super(new CMSProcessableBodyPartInbound(paramMimeMultipart.getBodyPart(0)), getInputStream((Part)paramMimeMultipart.getBodyPart(1)));
  ...
  public SMIMESigned(MimeMultipart paramMimeMultipart, String paramString) throws MessagingException, CMSException {
    super(new CMSProcessableBodyPartInbound(paramMimeMultipart.getBodyPart(0), paramString), getInputStream((Part)paramMimeMultipart.getBodyPart(1)));
    this.message = paramMimeMultipart;
    this.content = (MimeBodyPart)paramMimeMultipart.getBodyPart(0);
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/SMIMESigned.class
