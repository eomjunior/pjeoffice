...
public class FileBackedMimeBodyPart extends MimeBodyPart {
  ...
  public FileBackedMimeBodyPart(InputStream paramInputStream, File paramFile) throws MessagingException, IOException {
    this(saveStreamToFile(paramInputStream, paramFile));
  }
  
  public FileBackedMimeBodyPart(InternetHeaders paramInternetHeaders, InputStream paramInputStream, File paramFile) throws MessagingException, IOException {
  ...
  private static File saveStreamToFile(InternetHeaders paramInternetHeaders, InputStream paramInputStream, File paramFile) throws IOException {
    ...
    Enumeration<String> enumeration = paramInternetHeaders.getAllHeaderLines();
    while (enumeration.hasMoreElements())
      writeHeader(fileOutputStream, enumeration.nextElement()); 
  ...
  private static void writeSeperator(OutputStream paramOutputStream) throws IOException {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/util/FileBackedMimeBodyPart.class
