...
public class SharedFileInputStream extends FilterInputStream implements SharedInputStream {
  ...
  public SharedFileInputStream(String paramString) throws IOException {
    this(new File(paramString));
  }
  
  public SharedFileInputStream(File paramFile) throws IOException {
  ...
  public void dispose() throws IOException {
    Iterator<SharedFileInputStream> iterator = this._subStreams.iterator();
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/util/SharedFileInputStream.class
