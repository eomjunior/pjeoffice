...
public class SMIMECompressedParser extends CMSCompressedDataParser {
  ...
  public SMIMECompressedParser(MimeBodyPart paramMimeBodyPart) throws MessagingException, CMSException {
    this(paramMimeBodyPart, 0);
  }
  
  public SMIMECompressedParser(MimeMessage paramMimeMessage) throws MessagingException, CMSException {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/mail/smime/SMIMECompressedParser.class
