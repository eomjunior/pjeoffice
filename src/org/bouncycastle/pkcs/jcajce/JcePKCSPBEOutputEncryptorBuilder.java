    ...
    try {
      ...
      if (isPKCS12(this.algorithm)) {
        ...
        if (MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive)pBKDFConfig.getAlgorithm())) {
          ...
          PBES2Parameters pBES2Parameters = new PBES2Parameters(new KeyDerivationFunc(MiscObjectIdentifiers.id_scrypt, (ASN1Encodable)scryptParams), new EncryptionScheme(this.keyEncAlgorithm, (ASN1Encodable)ASN1Primitive.fromByteArray(cipher.getParameters().getEncoded())));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/pkcs/jcajce/JcePKCSPBEOutputEncryptorBuilder.class
