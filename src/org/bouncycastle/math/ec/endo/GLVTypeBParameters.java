...
public class GLVTypeBParameters {
  ...
  public GLVTypeBParameters(BigInteger paramBigInteger1, BigInteger paramBigInteger2, BigInteger[] paramArrayOfBigInteger1, BigInteger[] paramArrayOfBigInteger2, BigInteger paramBigInteger3, BigInteger paramBigInteger4, int paramInt) {
    ...
    this.splitParams = new ScalarSplitParameters(paramArrayOfBigInteger1, paramArrayOfBigInteger2, paramBigInteger3, paramBigInteger4, paramInt);
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/math/ec/endo/GLVTypeBParameters.class
