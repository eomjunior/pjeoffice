...
public abstract class Ed448 {
  ...
  private static boolean checkScalarVar(byte[] paramArrayOfbyte) {
    ...
    return !Nat.gte(14, arrayOfInt, L);
  }
  ...
  private static boolean decodePointVar(byte[] paramArrayOfbyte, int paramInt, boolean paramBoolean, PointExt paramPointExt) {
    byte[] arrayOfByte = Arrays.copyOfRange(paramArrayOfbyte, paramInt, paramInt + 57);
  ...
  private static boolean implVerify(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2, byte[] paramArrayOfbyte3, byte paramByte, byte[] paramArrayOfbyte4, int paramInt3, int paramInt4) {
    if (!checkContextVar(paramArrayOfbyte3))
      throw new IllegalArgumentException("ctx"); 
    byte[] arrayOfByte1 = Arrays.copyOfRange(paramArrayOfbyte1, paramInt1, paramInt1 + 57);
    byte[] arrayOfByte2 = Arrays.copyOfRange(paramArrayOfbyte1, paramInt1 + 57, paramInt1 + 114);
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/math/ec/rfc8032/Ed448.class
