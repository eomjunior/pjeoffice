...
public abstract class Ed25519 {
  ...
  private static boolean checkScalarVar(byte[] paramArrayOfbyte) {
    int[] arrayOfInt = new int[8];
    decodeScalar(paramArrayOfbyte, 0, arrayOfInt);
    return !Nat256.gte(arrayOfInt, L);
  }
  ...
  private static boolean decodePointVar(byte[] paramArrayOfbyte, int paramInt, boolean paramBoolean, PointAffine paramPointAffine) {
    byte[] arrayOfByte = Arrays.copyOfRange(paramArrayOfbyte, paramInt, paramInt + 32);
  ...
  private static boolean implVerify(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2, byte[] paramArrayOfbyte3, byte paramByte, byte[] paramArrayOfbyte4, int paramInt3, int paramInt4) {
    if (!checkContextVar(paramArrayOfbyte3, paramByte))
      throw new IllegalArgumentException("ctx"); 
    byte[] arrayOfByte1 = Arrays.copyOfRange(paramArrayOfbyte1, paramInt1, paramInt1 + 32);
    byte[] arrayOfByte2 = Arrays.copyOfRange(paramArrayOfbyte1, paramInt1 + 32, paramInt1 + 64);
    if (!checkPointVar(arrayOfByte1))
      return false; 
    if (!checkScalarVar(arrayOfByte2))
      return false; 
    ...
    decodeScalar(arrayOfByte2, 0, arrayOfInt1);
    int[] arrayOfInt2 = new int[8];
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/math/ec/rfc8032/Ed25519.class
