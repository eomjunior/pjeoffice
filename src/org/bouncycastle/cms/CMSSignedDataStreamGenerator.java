...
public class CMSSignedDataStreamGenerator extends CMSSignedGenerator {
  ...
  public OutputStream open(ASN1ObjectIdentifier paramASN1ObjectIdentifier, OutputStream paramOutputStream1, boolean paramBoolean, OutputStream paramOutputStream2) throws IOException {
    ...
    for (SignerInformation signerInformation : this._signers) {
      AlgorithmIdentifier algorithmIdentifier = CMSSignedHelper.INSTANCE.fixAlgID(signerInformation.getDigestAlgorithmID());
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/cms/CMSSignedDataStreamGenerator.class
