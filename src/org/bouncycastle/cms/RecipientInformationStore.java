...
public class RecipientInformationStore implements Iterable<RecipientInformation> {
  ...
  public Collection<RecipientInformation> getRecipients(RecipientId paramRecipientId) {
    ...
    return (arrayList == null) ? new ArrayList<RecipientInformation>() : new ArrayList<RecipientInformation>(arrayList);
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/cms/RecipientInformationStore.class
