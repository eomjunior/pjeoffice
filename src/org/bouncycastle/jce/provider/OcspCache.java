...
class OcspCache {
  ...
  static OCSPResponse getOcspResponse(CertID paramCertID, PKIXCertRevocationCheckerParameters paramPKIXCertRevocationCheckerParameters, URI paramURI, X509Certificate paramX509Certificate, List<Extension> paramList, JcaJceHelper paramJcaJceHelper) throws CertPathValidatorException {
    ...
    TBSRequest tBSRequest = new TBSRequest(null, (ASN1Sequence)new DERSequence(aSN1EncodableVector1), Extensions.getInstance(new DERSequence(aSN1EncodableVector2)));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jce/provider/OcspCache.class
