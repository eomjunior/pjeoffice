...
class CrlCache {
  ...
  static synchronized PKIXCRLStore getCrl(CertificateFactory paramCertificateFactory, Date paramDate, URI paramURI) throws IOException, CRLException {
    ...
    LocalCRLStore<CRL> localCRLStore = new LocalCRLStore<CRL>((Store<CRL>)new CollectionStore(collection));
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/jce/provider/CrlCache.class
