...
public class DefaultDigestAlgorithmIdentifierFinder implements DigestAlgorithmIdentifierFinder {
  ...
  public AlgorithmIdentifier find(AlgorithmIdentifier paramAlgorithmIdentifier) {
    ...
    } else if (paramAlgorithmIdentifier.getAlgorithm().equals((ASN1Primitive)EdECObjectIdentifiers.id_Ed25519)) {
      algorithmIdentifier = new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha512);
    } else if (paramAlgorithmIdentifier.getAlgorithm().equals((ASN1Primitive)EdECObjectIdentifiers.id_Ed448)) {
      algorithmIdentifier = new AlgorithmIdentifier(NISTObjectIdentifiers.id_shake256_len, (ASN1Encodable)new ASN1Integer(512L));
    } else {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/operator/DefaultDigestAlgorithmIdentifierFinder.class
