  ...
  private static ASN1Sequence createCompParams(CompositeAlgorithmSpec paramCompositeAlgorithmSpec) {
    ...
    for (byte b = 0; b != list.size(); b++) {
      ...
      if (algorithmParameterSpec == null) {
        ...
        aSN1EncodableVector.add((ASN1Encodable)createPSSParams((PSSParameterSpec)algorithmParameterSpec));
      } else {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/operator/jcajce/JcaContentSignerBuilder.class
