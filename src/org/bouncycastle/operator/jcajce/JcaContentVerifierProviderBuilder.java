  ...
  private class CompositeVerifier implements ContentVerifier {
    ...
    public boolean verify(byte[] param1ArrayOfbyte) {
      try {
        ...
        boolean bool = false;
        for (byte b = 0; b != aSN1Sequence.size(); b++) {
          if (this.sigs[b] != null && !this.sigs[b].verify(DERBitString.getInstance(aSN1Sequence.getObjectAt(b)).getBytes()))
            bool = true; 
        } 
        return !bool;
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/operator/jcajce/JcaContentVerifierProviderBuilder.class
