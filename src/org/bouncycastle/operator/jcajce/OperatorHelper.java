...
class OperatorHelper {
  ...
  Signature createSignature(AlgorithmIdentifier paramAlgorithmIdentifier) throws GeneralSecurityException {
    ...
    try {
      ...
      } else if (oids.get(paramAlgorithmIdentifier.getAlgorithm()) != null) {
        String str1 = (String)oids.get(paramAlgorithmIdentifier.getAlgorithm());
        signature = this.helper.createSignature(str1);
      } else {
        throw noSuchAlgorithmException;
      } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/bouncycastle/operator/jcajce/OperatorHelper.class
