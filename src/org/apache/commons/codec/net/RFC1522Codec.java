...
/*  74 */     buffer.append("=?");
/*  75 */     buffer.append(charset);
/*  76 */     buffer.append('?');
/*  77 */     buffer.append(getEncoding());
/*  78 */     buffer.append('?');
/*  79 */     buffer.append(StringUtils.newStringUsAscii(doEncoding(text.getBytes(charset))));
/*  80 */     buffer.append("?=");
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/apache/commons/codec/net/RFC1522Codec.class
