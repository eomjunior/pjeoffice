...
/* 115 */     this(SSLContexts.createSystemDefault(), (SecurePortStrategy)new FixedPortStrategy(securePorts));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 150 */     return (this.securePortStrategy == null || this.securePortStrategy.isSecure(localAddress));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 160 */     tlsSession.startTls(this.sslContext, endpoint, this.sslBufferMode, 
/*     */ 
/*     */ 
/*     */         
/* 164 */         H2TlsSupport.enforceRequirements(attachment, this.initializer), this.verifier, handshakeTimeout, callback);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 183 */       upgrade(tlsSession, (NamedEndpoint)host, attachment, handshakeTimeout, null);
/* 184 */       return true;
/*     */     } 
/* 186 */     return false;
/*     */   }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/apache/hc/core5/http2/ssl/H2ServerTlsStrategy.class
