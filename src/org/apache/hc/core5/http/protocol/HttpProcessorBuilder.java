...
/*  53 */       this.requestChainBuilder = new ChainBuilder<>();
/*     */     }
...
/*  60 */       this.responseChainBuilder = new ChainBuilder<>();
/*     */     }
...
/* 146 */     return new DefaultHttpProcessor((this.requestChainBuilder != null) ? this.requestChainBuilder
/* 147 */         .build() : null, (this.responseChainBuilder != null) ? this.responseChainBuilder
/* 148 */         .build() : null);
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/apache/hc/core5/http/protocol/HttpProcessorBuilder.class
