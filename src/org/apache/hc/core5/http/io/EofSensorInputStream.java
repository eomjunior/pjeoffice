...
/* 253 */     InputStream toAbortStream = this.wrappedStream;
/* 254 */     if (toAbortStream != null) {
/*     */       try {
/* 256 */         boolean scws = true;
/* 257 */         if (this.eofWatcher != null) {
/* 258 */           scws = this.eofWatcher.streamAbort(toAbortStream);
/*     */         }
/* 260 */         if (scws) {
/* 261 */           toAbortStream.close();
/*     */         }
/*     */       } finally {
...
/* 281 */     this.selfClosed = true;
/* 282 */     checkAbort();
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/org/apache/hc/core5/http/io/EofSensorInputStream.class
