...
/* 36 */     this.other.subscribe(new OtherObserver<T, Object>(observer, this.source));
/*    */   }
/*    */ 
/*    */   
...
/* 64 */       this.source.subscribe((SingleObserver)new ResumeSingleObserver(this, this.downstream));
/*    */     }
/*    */ 
/*    */     
/*    */     public void onError(Throwable e) {
/* 69 */       this.downstream.onError(e);
/*    */     }
/*    */ 
/*    */     
/*    */     public void dispose() {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/io/reactivex/internal/operators/single/SingleDelayWithSingle.class
