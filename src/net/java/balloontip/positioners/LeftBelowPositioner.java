...
/*    */ 
/*    */ 
/*    */ public class LeftBelowPositioner
...
/*    */       
/* 42 */       if (this.y + balloonHeight > this.balloonTip.getTopLevelContainer().getHeight()) {
/* 43 */         this.flipY = false;
/* 44 */         if (this.fixedAttachLocation) {
/* 45 */           this.y -= balloonHeight;
/*    */         } else {
/* 47 */           this.y = attached.y - balloonHeight;
/*    */         } 
/*    */       } 
/*    */ 
/*    */       
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/net/java/balloontip/positioners/LeftBelowPositioner.class
