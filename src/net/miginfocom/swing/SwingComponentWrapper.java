    ...
    if (this.bl == null)
      try {
        if (BL_RES_METHOD == null || BL_RES_METHOD.invoke(this.c, new Object[0]).toString().equals("OTHER")) {
          ...
          this.bl = new Boolean((getBaseline(dimension.width, dimension.height) > -1));
        } 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/net/miginfocom/swing/SwingComponentWrapper.class
