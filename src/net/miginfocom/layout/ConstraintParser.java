      ...
      try {
        ...
        if (c == 'a') {
          ...
          if (i > -1) {
            ...
            lC.setAlignY((arrayOfString1.length > 1) ? parseUnitValueOrAlign(arrayOfString1[1], false, null) : lC.getAlignX());
            continue;
          } 
        } 
        if (c == 'p') {
        ...
        if (c == 'p') {
          ...
          if (i > -1) {
            ...
            for (byte b1 = 0; b1 < arrayOfString1.length; b1++)
              arrayOfUnitValue[b1] = parseUnitValue(arrayOfString1[b1], null, (b1 % 2 == 0)); 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/net/miginfocom/layout/ConstraintParser.class
