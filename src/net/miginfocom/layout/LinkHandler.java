    ...
    for (int i = LAYOUTS.size() - 1; i >= 0; i--) {
      ...
      if (integer == null && object == paramObject) {
        ...
        if (bool && arrayOfInt != null && arrayOfInt[paramInt] != -2147471302) {
          integer = new Integer(arrayOfInt[paramInt]);
        } else {
          arrayOfInt = (int[])((HashMap)VALUES.get(i)).get(paramString);
          integer = (arrayOfInt != null && arrayOfInt[paramInt] != -2147471302) ? new Integer(arrayOfInt[paramInt]) : null;
        } 
        bool = false;
      } 
      if (object == null) {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/net/miginfocom/layout/LinkHandler.class
