...
public final class Grid {
  ...
  public Grid(ContainerWrapper paramContainerWrapper, LC paramLC, AC paramAC1, AC paramAC2, Map<ComponentWrapper, CC> paramMap, ArrayList<LayoutCallback> paramArrayList) {
    ...
    if (b1 > 0 || b2 > 0) {
      ...
      for (Cell cell : this.grid.values()) {
        for (byte b5 = 0; b5 < cell.compWraps.size(); b5++) {
          CompWrap compWrap = cell.compWraps.get(b5);
    ...
    while (b4 < m) {
      this.rowIndexes.add(new Integer(b4));
      b4++;
    } 
    b4 = 0;
    m = paramAC2.getCount();
    while (b4 < m) {
      this.colIndexes.add(new Integer(b4));
      b4++;
    } 
      ...
      for (byte b = 0; b < ((this.linkTargetIDs != null) ? 2 : 1); b++) {
        ...
        do {
          ...
          while (iterator.hasNext()) {
            ArrayList<CompWrap> arrayList = (iterator.next()).compWraps;
            byte b2 = 0;
  ...
  public void paintDebug() {
    if (this.debugRects != null) {
      ...
      Iterator<Cell> iterator = this.grid.values().iterator();
      while (iterator.hasNext()) {
        ArrayList<CompWrap> arrayList1 = (iterator.next()).compWraps;
        byte b1 = 0;
  ...
  private static final int getDockInsets(TreeSet<Integer> paramTreeSet) {
    byte b = 0;
    Iterator<Integer> iterator = paramTreeSet.iterator();
  ...
  private final void wrap(int[] paramArrayOfint, BoundSize paramBoundSize) {
    ...
    if (paramBoundSize != null) {
      ...
      this.wrapGapMap.put(new Integer(paramArrayOfint[bool ? 1 : 0]), paramBoundSize);
    } 
    if (bool) {
  ...
  private Float[] getDefaultPushWeights(boolean paramBoolean) {
    ...
    for (boolean bool = true; b < arrayOfArrayList.length; bool += true) {
      ...
      for (byte b1 = 0; b1 < arrayList.size(); b1++) {
        LinkedDimGroup linkedDimGroup = arrayList.get(b1);
        for (byte b2 = 0; b2 < linkedDimGroup._compWraps.size(); b2++) {
          CompWrap compWrap = linkedDimGroup._compWraps.get(b2);
          byte b3 = compWrap.comp.isVisible() ? -1 : ((compWrap.cc.getHideMode() != -1) ? compWrap.cc.getHideMode() : this.lc.getHideMode());
          Float float_1 = (b3 < 2) ? (paramBoolean ? compWrap.cc.getPushY() : compWrap.cc.getPushX()) : null;
  ...
  private static LinkedDimGroup getGroupContaining(ArrayList<LinkedDimGroup>[] paramArrayOfArrayList, CompWrap paramCompWrap) {
    for (byte b = 0; b < paramArrayOfArrayList.length; b++) {
      ...
      while (b1 < i) {
        ArrayList<CompWrap> arrayList1 = (arrayList.get(b1))._compWraps;
        byte b2 = 0;
        int j = arrayList1.size();
        while (b2 < j) {
          if (arrayList1.get(b2) == paramCompWrap)
            return arrayList.get(b1); 
          b2++;
        } 
        b1++;
      } 
  ...
  private void layoutInOneDim(int paramInt, UnitValue paramUnitValue, boolean paramBoolean, Float[] paramArrayOfFloat) {
    ...
    int i = (paramUnitValue != null) ? Math.round(paramUnitValue.getPixels((paramInt - LayoutUtil.sum(arrayOfInt)), this.container, null)) : 0;
    if (bool)
      i = paramInt - i; 
  ...
  private static boolean[] getComponentGapPush(ArrayList<CompWrap> paramArrayList, boolean paramBoolean) {
    ...
    for (byte b = 0; b < arrayOfBoolean.length; b++) {
      boolean bool = (b > 0) ? ((CompWrap)paramArrayList.get(b - 1)).isPushGap(paramBoolean, false) : false;
  ...
  private int[][] getRowGaps(DimConstraint[] paramArrayOfDimConstraint, int paramInt, boolean paramBoolean, boolean[] paramArrayOfboolean) {
    ...
    while (b1 < arrayOfInt1.length) {
      ...
      if (!bool1 || !bool2) {
        BoundSize boundSize1 = (this.wrapGapMap == null || paramBoolean == this.lc.isFlowX()) ? null : this.wrapGapMap.get(new Integer(b2++));
        if (boundSize1 == null) {
  ...
  private void adjustMinPrefForSpanningComps(DimConstraint[] paramArrayOfDimConstraint, Float[] paramArrayOfFloat, FlowSizeSpec paramFlowSizeSpec, ArrayList<LinkedDimGroup>[] paramArrayOfArrayList) {
    for (int i = paramArrayOfArrayList.length - 1; i >= 0; i--) {
      ...
      for (byte b = 0; b < arrayList.size(); b++) {
        LinkedDimGroup linkedDimGroup = arrayList.get(b);
        if (linkedDimGroup.span != 1) {
  ...
  private ArrayList<LinkedDimGroup>[] divideIntoLinkedGroups(boolean paramBoolean) {
    ...
    while (iterator.hasNext()) {
      ...
      while (iterator1.hasNext()) {
        ...
        Cell cell = paramBoolean ? getCell(i, j) : getCell(j, i);
        if (cell == null || cell.compWraps.size() == 0)
          continue; 
        ...
        if ((!bool1 && cell.compWraps.size() > 1) || k > 1) {
          ...
          LinkedDimGroup linkedDimGroup = new LinkedDimGroup("p," + j, k, bool2, !paramBoolean, bool);
  ...
  private Cell getCell(int paramInt1, int paramInt2) {
    return this.grid.get(new Integer((paramInt1 << 16) + paramInt2));
  }
  ...
  private void addDockingCell(int[] paramArrayOfint, int paramInt, CompWrap paramCompWrap) {
    ...
    this.grid.put(new Integer((i << 16) + j), new Cell(paramCompWrap, k, m, (k > 1)));
  }
  ...
  static synchronized HashMap<Object, int[]> getGridPositions(Object paramObject) {
    if (PARENT_GRIDPOS_MAP == null)
      return null; 
    LinkedHashMap linkedHashMap = PARENT_GRIDPOS_MAP.get(paramObject);
  ...
  private static final class CompWrap {
    ...
    private final int getSize(BoundSize param1BoundSize, int param1Int1, boolean param1Boolean, int param1Int2) {
    ...
    private final void calcGaps(ComponentWrapper param1ComponentWrapper1, CC param1CC1, ComponentWrapper param1ComponentWrapper2, CC param1CC2, String param1String, boolean param1Boolean1, boolean param1Boolean2) {
      ContainerWrapper containerWrapper = this.comp.getParent();
    ...
    private final void setDimBounds(int param1Int1, int param1Int2, boolean param1Boolean) {
      if (param1Boolean) {
        this.x = param1Int1;
        this.w = param1Int2;
      } else {
    ...
    private final boolean isPushGap(boolean param1Boolean1, boolean param1Boolean2) {
    ...
    private final boolean transferBounds(boolean param1Boolean) {
    ...
    private final void setSizes(int[] param1ArrayOfint, boolean param1Boolean) {
    ...
    private final void mergeGapSizes(int[] param1ArrayOfint, boolean param1Boolean1, boolean param1Boolean2) {
      if (this.gaps == null)
        this.gaps = new int[][] { null, null, null, null }; 
      if (param1ArrayOfint == null)
        return; 
    ...
    private final int getGapIx(boolean param1Boolean1, boolean param1Boolean2) {
      return param1Boolean1 ? (param1Boolean2 ? 1 : 3) : (param1Boolean2 ? 0 : 2);
    }
    
    private final int getSizeInclGaps(int param1Int, boolean param1Boolean) {
    ...
    private final int getSize(int param1Int, boolean param1Boolean) {
      return filter(param1Int, param1Boolean ? this.horSizes[param1Int] : this.verSizes[param1Int]);
    }
    
    private final int getGapBefore(int param1Int, boolean param1Boolean) {
      int[] arrayOfInt = getGaps(param1Boolean, true);
      return (arrayOfInt != null) ? filter(param1Int, arrayOfInt[param1Int]) : 0;
    }
    
    private final int getGapAfter(int param1Int, boolean param1Boolean) {
      int[] arrayOfInt = getGaps(param1Boolean, false);
      return (arrayOfInt != null) ? filter(param1Int, arrayOfInt[param1Int]) : 0;
    }
    
    private final int[] getGaps(boolean param1Boolean1, boolean param1Boolean2) {
      return this.gaps[getGapIx(param1Boolean1, param1Boolean2)];
    }
    
    private final int filter(int param1Int1, int param1Int2) {
      return (param1Int2 == -2147471302) ? ((param1Int1 != 2) ? 0 : 2097051) : Grid.constrainSize(param1Int2);
    }
    
    private final boolean isBaselineAlign(boolean param1Boolean) {
    ...
    private final int getBaseline(int param1Int) {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/net/miginfocom/layout/Grid.class
