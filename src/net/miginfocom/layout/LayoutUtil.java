...
public final class LayoutUtil {
    ...
    if (i != paramInt2 && paramArrayOfResizeConstraint != null) {
      ...
      for (byte b1 = 0; b1 < paramArrayOfint.length; b1++) {
        ...
        if (resizeConstraint != null)
          treeSet.add(new Integer(bool ? resizeConstraint.growPrio : resizeConstraint.shrinkPrio)); 
      } 
  ...
  private static int getBrokenBoundary(float paramFloat, int paramInt1, int paramInt2) {
    ...
    return (paramInt2 != -2147471302 && paramFloat > paramInt2) ? (new Integer(paramInt2)).intValue() : -2147471302;
  }
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/net/miginfocom/layout/LayoutUtil.class
