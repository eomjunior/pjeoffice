...
/*    */ 
/*    */ 
/*    */ class PjeFileWatchClient
/*    */   extends PjeClientWrapper
/*    */ {
/*    */   PjeFileWatchClient(Supplier<IPjeJsonCodec> codec, Supplier<ICanceller> canceller) {
/* 48 */     super(new PJeJsonClient(codec, canceller));
/*    */   }
/*    */   
/*    */   static class PjeFileJsonCodec extends CloseablePjeSocketCodec<JSONObject> implements IPjeJsonCodec {
/*    */     private final Charset charset;
/*    */     private final Supplier<IGetCodec> codec;
/*    */     
/*    */     PjeFileJsonCodec(Charset charset, Supplier<IGetCodec> codec) {
/* 56 */       this.charset = (Charset)Args.requireNonNull(charset, "charset is null");
/* 57 */       this.codec = (Supplier<IGetCodec>)Args.requireNonNull(codec, "codec is null");
/*    */     }
/*    */ 
/*    */     
/*    */     protected PjeTaskResponse doPost(IProvider<JSONObject> provider, IResultChecker checker) throws Exception {
/* 62 */       return new PjeFileWatchTaskResponse(((JSONObject)provider.get()).toString(), this.charset);
/*    */     }
/*    */ 
/*    */     
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/br/jus/cnj/pje/office/core/imp/PjeFileWatchClient.class
