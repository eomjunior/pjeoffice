...
/*  23 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(null, getAffineXCoord(), getAffineYCoord());
/*     */   }
/*     */ 
/*     */   
...
/*     */       {
/* 133 */         return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement13, eCCurve.getB());
/*     */       }
/*     */       
...
/*     */       {
/* 150 */         return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement13, eCCurve.getB());
/*     */       }
/*     */       
...
/*     */     } 
/*     */     
/* 168 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/* 195 */       return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement6, eCCurve.getB());
/*     */     }
/*     */     
...
/*     */     
/* 201 */     ECFieldElement eCFieldElement9 = eCFieldElement2.add(eCFieldElement1).square();
/* 202 */     ECFieldElement eCFieldElement10 = eCFieldElement9.add(eCFieldElement6).add(eCFieldElement5).multiply(eCFieldElement9).add(eCFieldElement7);
/*     */     
/* 204 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement7, eCFieldElement10, new ECFieldElement[] { eCFieldElement8 });
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 228 */     ECFieldElement eCFieldElement2 = paramECPoint.getRawXCoord(), eCFieldElement3 = paramECPoint.getZCoord(0);
/* 229 */     if (eCFieldElement2.isZero() || !eCFieldElement3.isOne())
/*     */     {
/* 231 */       return twice().add(paramECPoint);
/*     */     }
/*     */     
/* 234 */     ECFieldElement eCFieldElement4 = this.y, eCFieldElement5 = this.zs[0];
/* 235 */     ECFieldElement eCFieldElement6 = paramECPoint.getRawYCoord();
/*     */     
/* 237 */     ECFieldElement eCFieldElement7 = eCFieldElement1.square();
/* 238 */     ECFieldElement eCFieldElement8 = eCFieldElement4.square();
/* 239 */     ECFieldElement eCFieldElement9 = eCFieldElement5.square();
/* 240 */     ECFieldElement eCFieldElement10 = eCFieldElement4.multiply(eCFieldElement5);
/*     */     
/* 242 */     ECFieldElement eCFieldElement11 = eCFieldElement9.add(eCFieldElement8).add(eCFieldElement10);
/* 243 */     ECFieldElement eCFieldElement12 = eCFieldElement6.multiply(eCFieldElement9).add(eCFieldElement8).multiplyPlusProduct(eCFieldElement11, eCFieldElement7, eCFieldElement9);
/* 244 */     ECFieldElement eCFieldElement13 = eCFieldElement2.multiply(eCFieldElement9);
/* 245 */     ECFieldElement eCFieldElement14 = eCFieldElement13.add(eCFieldElement11).square();
/*     */     
/* 247 */     if (eCFieldElement14.isZero()) {
/*     */       
/* 249 */       if (eCFieldElement12.isZero())
/*     */       {
/* 251 */         return paramECPoint.twice();
/*     */       }
/*     */       
/* 254 */       return eCCurve.getInfinity();
/*     */     } 
/*     */     
/* 257 */     if (eCFieldElement12.isZero())
/*     */     {
/* 259 */       return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement12, eCCurve.getB());
/*     */     }
/*     */     
/* 262 */     ECFieldElement eCFieldElement15 = eCFieldElement12.square().multiply(eCFieldElement13);
/* 263 */     ECFieldElement eCFieldElement16 = eCFieldElement12.multiply(eCFieldElement14).multiply(eCFieldElement9);
/* 264 */     ECFieldElement eCFieldElement17 = eCFieldElement12.add(eCFieldElement14).square().multiplyPlusProduct(eCFieldElement11, eCFieldElement6.addOne(), eCFieldElement16);
/*     */     
/* 266 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement15, eCFieldElement17, new ECFieldElement[] { eCFieldElement16 });
/*     */   }
/*     */ 
/*     */   
...
/* 271 */     if (isInfinity())
/*     */     {
/* 273 */       return (ECPoint)this;
/*     */     }
/*     */     
/* 276 */     ECFieldElement eCFieldElement1 = this.x;
/* 277 */     if (eCFieldElement1.isZero())
/*     */     {
/* 279 */       return (ECPoint)this;
/*     */     }
/*     */ 
/*     */     
/* 283 */     ECFieldElement eCFieldElement2 = this.y, eCFieldElement3 = this.zs[0];
/* 284 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/META-INF/versions/9/org/bouncycastle/math/ec/custom/sec/SecT163K1Point.class
