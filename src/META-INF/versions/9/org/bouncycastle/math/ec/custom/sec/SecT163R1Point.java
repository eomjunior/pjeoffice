...
/*  23 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163R1Point(null, getAffineXCoord(), getAffineYCoord());
/*     */   }
/*     */ 
/*     */   
...
/*     */       {
/* 133 */         return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt());
/*     */       }
/*     */       
...
/*     */       {
/* 150 */         return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt());
/*     */       }
/*     */       
...
/*     */     } 
/*     */     
/* 168 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163R1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/* 197 */       return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163R1Point(eCCurve, eCFieldElement8, eCCurve.getB().sqrt());
/*     */     }
/*     */     
...
/*     */     
/* 206 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163R1Point(eCCurve, eCFieldElement9, eCFieldElement12, new ECFieldElement[] { eCFieldElement10 });
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/* 261 */       return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt());
/*     */     }
/*     */     
...
/*     */     
/* 268 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163R1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[] { eCFieldElement17 });
/*     */   }
/*     */ 
/*     */   
...
/* 286 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/META-INF/versions/9/org/bouncycastle/math/ec/custom/sec/SecT163R1Point.class
