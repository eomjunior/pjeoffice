...
/*  23 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(null, getAffineXCoord(), getAffineYCoord());
/*     */   }
/*     */ 
/*     */   
...
/*     */       {
/* 133 */         return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement13, eCCurve.getB());
/*     */       }
/*     */       
...
/*     */       {
/* 150 */         return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement13, eCCurve.getB());
/*     */       }
/*     */       
...
/*     */     } 
/*     */     
/* 168 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
/*     */   }
/*     */   
...
/*     */     {
/* 204 */       return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement5, eCCurve.getB());
/*     */     }
/*     */     
...
/*     */     
/* 214 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement6, eCFieldElement10, new ECFieldElement[] { eCFieldElement7 });
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/* 270 */       return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement13, eCCurve.getB());
/*     */     }
/*     */     
...
/*     */     
/* 277 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[] { eCFieldElement17 });
/*     */   }
/*     */ 
/*     */   
...
/* 295 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/META-INF/versions/9/org/bouncycastle/math/ec/custom/sec/SecT239K1Point.class
