...
/*  23 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409R1Point(null, getAffineXCoord(), getAffineYCoord());
/*     */   }
/*     */ 
/*     */   
...
/*     */       {
/* 133 */         return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt());
/*     */       }
/*     */       
...
/*     */       {
/* 150 */         return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt());
/*     */       }
/*     */       
...
/*     */     } 
/*     */     
/* 168 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409R1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/* 195 */       return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409R1Point(eCCurve, eCFieldElement6, eCCurve.getB().sqrt());
/*     */     }
/*     */     
...
/*     */     
/* 204 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409R1Point(eCCurve, eCFieldElement7, eCFieldElement10, new ECFieldElement[] { eCFieldElement8 });
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/* 258 */       return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409R1Point(eCCurve, eCFieldElement12, eCCurve.getB().sqrt());
/*     */     }
/*     */     
...
/*     */     
/* 265 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409R1Point(eCCurve, eCFieldElement15, eCFieldElement17, new ECFieldElement[] { eCFieldElement16 });
/*     */   }
/*     */ 
/*     */   
...
/* 283 */     return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/META-INF/versions/9/org/bouncycastle/math/ec/custom/sec/SecT409R1Point.class
