...
/*     */         
/*  37 */         throw new InvalidKeySpecException(exception.toString(), exception);
/*     */       } 
/*     */     } 
/*     */     
...
/*     */         
/*  60 */         throw new InvalidKeySpecException(exception.toString(), exception);
/*     */       } 
/*     */     } 
/*     */     
...
/*  70 */     if (paramKey instanceof BCLMSPrivateKey) {
/*     */       
...
/*     */       }
/*     */     }
/*  77 */     else if (paramKey instanceof BCLMSPublicKey) {
/*     */       
...
/*  97 */     if (paramKey instanceof BCLMSPrivateKey || paramKey instanceof BCLMSPublicKey)
/*     */     {
/*  99 */       return paramKey;
/*     */     }
/*     */     
...
/* 108 */     return (PrivateKey)new BCLMSPrivateKey(paramPrivateKeyInfo);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public PublicKey generatePublic(SubjectPublicKeyInfo paramSubjectPublicKeyInfo) throws IOException {
/* 114 */     return (PublicKey)new BCLMSPublicKey(paramSubjectPublicKeyInfo);
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/META-INF/versions/9/org/bouncycastle/pqc/jcajce/provider/lms/LMSKeyFactorySpi.class
