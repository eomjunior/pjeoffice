...
/*  73 */     if (paramClass.isAssignableFrom(OpenSSHPrivateKeySpec.class) && paramKey instanceof BCEdDSAPrivateKey) {
/*     */       
/*     */       try {
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/*  94 */     if (paramClass.isAssignableFrom(OpenSSHPublicKeySpec.class) && paramKey instanceof BCEdDSAPublicKey) {
/*     */       
/*     */       try {
/*     */         
...
/*     */       } 
/*     */     }
/* 105 */     if (paramClass.isAssignableFrom(OpenSSHPrivateKeySpec.class) && paramKey instanceof BCEdDSAPrivateKey) {
/*     */       
/*     */       try {
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 126 */     if (paramClass.isAssignableFrom(OpenSSHPublicKeySpec.class) && paramKey instanceof BCEdDSAPublicKey) {
/*     */       
/*     */       try {
/*     */         
...
/*     */       {
/* 150 */         return (PrivateKey)new BCEdDSAPrivateKey(asymmetricKeyParameter);
/*     */       }
...
/*     */           case 113:
/* 193 */             return (PublicKey)new BCEdDSAPublicKey(Ed448Prefix, arrayOfByte);
/*     */           case 112:
/* 195 */             return (PublicKey)new BCEdDSAPublicKey(Ed25519Prefix, arrayOfByte);
/*     */         } 
...
/*     */       {
/* 206 */         return (PublicKey)new BCEdDSAPublicKey(new byte[0], ((Ed25519PublicKeyParameters)asymmetricKeyParameter).getEncoded());
/*     */       }
/*     */       
...
/*     */       {
/* 235 */         return (PrivateKey)new BCEdDSAPrivateKey(paramPrivateKeyInfo);
/*     */       }
...
/*     */       {
/* 239 */         return (PrivateKey)new BCEdDSAPrivateKey(paramPrivateKeyInfo);
/*     */       }
/*     */     } 
/*     */     
...
/*     */       {
/* 266 */         return (PublicKey)new BCEdDSAPublicKey(paramSubjectPublicKeyInfo);
/*     */       }
...
/*     */       {
/* 270 */         return (PublicKey)new BCEdDSAPublicKey(paramSubjectPublicKeyInfo);
/*     */       }
/*     */     } 
/*     */     
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/META-INF/versions/11/org/bouncycastle/jcajce/provider/asymmetric/edec/KeyFactorySpi.class
