...
/*  41 */     if (o == null)
/*  42 */       throw new IllegalStateException(message); 
/*  43 */     return o;
/*     */   }
/*     */   
...
/*  71 */     if (value < 0L)
/*  72 */       throw new IllegalStateException(message); 
/*  73 */     return value;
/*     */   }
/*     */   
...
/* 127 */     return requireExists(path, message, LinkOption.NOFOLLOW_LINKS);
/*     */   }
/*     */   
...
/* 155 */     if (Containers.isEmpty(collection))
/* 156 */       throw new IllegalStateException(message); 
/* 157 */     return collection;
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/github/utils4j/imp/States.class
