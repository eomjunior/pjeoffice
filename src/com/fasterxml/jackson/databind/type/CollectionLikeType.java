...
/*  34 */     super(collT, bindings, superClass, superInts, elemT
/*  35 */         .hashCode(), valueHandler, typeHandler, asStatic);
...
/*  73 */         _bogusSuperClass(rawType), null, elemT, null, null, false);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 118 */     return new CollectionLikeType(this._class, this._bindings, this._superClass, this._superInterfaces, this._elementType
/* 119 */         .withTypeHandler(h), this._valueHandler, this._typeHandler, this._asStatic);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 131 */     return new CollectionLikeType(this._class, this._bindings, this._superClass, this._superInterfaces, this._elementType
/* 132 */         .withValueHandler(h), this._valueHandler, this._typeHandler, this._asStatic);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 152 */       return this;
/*     */     }
/* 154 */     return new CollectionLikeType(this._class, this._bindings, this._superClass, this._superInterfaces, this._elementType
/* 155 */         .withStaticTyping(), this._valueHandler, this._typeHandler, true);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 217 */     if (this._elementType != null && _hasNTypeParameters(1)) {
/* 218 */       sb.append('<');
/* 219 */       sb.append(this._elementType.toCanonical());
/* 220 */       sb.append('>');
/*     */     } 
...
/* 241 */     return Collection.class.isAssignableFrom(this._class);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 257 */     CollectionLikeType other = (CollectionLikeType)o;
/* 258 */     return (this._class == other._class && this._elementType.equals(other._elementType));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String toString() {
/* 264 */     return "[collection-like type; class " + this._class.getName() + ", contains " + this._elementType + "]";
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/type/CollectionLikeType.class
