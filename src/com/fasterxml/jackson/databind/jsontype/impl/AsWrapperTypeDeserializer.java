...
/*     */     } 
/*     */     
/*  92 */     JsonToken t = p.currentToken();
/*  93 */     if (t == JsonToken.START_OBJECT) {
/*     */       
/*  95 */       if (p.nextToken() != JsonToken.FIELD_NAME) {
/*  96 */         ctxt.reportWrongTokenException(baseType(), JsonToken.FIELD_NAME, "need JSON String that contains type id (for subtype of " + 
/*  97 */             baseTypeName() + ")", new Object[0]);
/*     */       }
/*  99 */     } else if (t != JsonToken.FIELD_NAME) {
/* 100 */       ctxt.reportWrongTokenException(baseType(), JsonToken.START_OBJECT, "need JSON Object to contain As.WRAPPER_OBJECT type information for class " + 
/* 101 */           baseTypeName(), new Object[0]);
/*     */     } 
...
/*     */ 
/*     */     
/* 108 */     if (this._typeIdVisible && p.hasToken(JsonToken.START_OBJECT)) {
/*     */       
/* 110 */       TokenBuffer tb = ctxt.bufferForInputBuffering(p);
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/jsontype/impl/AsWrapperTypeDeserializer.class
