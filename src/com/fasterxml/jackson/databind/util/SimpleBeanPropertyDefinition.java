...
/*  74 */     return new SimpleBeanPropertyDefinition(config.getAnnotationIntrospector(), member, 
/*  75 */         PropertyName.construct(member.getName()), null, EMPTY_INCLUDE);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  97 */     JsonInclude.Value inclValue = (inclusion == null || inclusion == JsonInclude.Include.USE_DEFAULTS) ? EMPTY_INCLUDE : JsonInclude.Value.construct(inclusion, null);
...
/* 241 */     if (this._member instanceof AnnotatedMethod && ((AnnotatedMethod)this._member)
/* 242 */       .getParameterCount() == 0) {
...
/* 250 */     if (this._member instanceof AnnotatedMethod && ((AnnotatedMethod)this._member)
/* 251 */       .getParameterCount() == 1) {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/util/SimpleBeanPropertyDefinition.class
