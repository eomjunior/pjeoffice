...
/*  92 */               Character.valueOf((offset < 0) ? 45 : 43), 
...
/* 273 */     return (offset < value.length() && value.charAt(offset) == expected);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 286 */     if (beginIndex < 0 || endIndex > value.length() || beginIndex > endIndex) {
/* 287 */       throw new NumberFormatException(value);
/*     */     }
/*     */     
/* 290 */     int i = beginIndex;
/* 291 */     int result = 0;
/*     */     
/* 293 */     if (i < endIndex) {
/* 294 */       int digit = Character.digit(value.charAt(i++), 10);
/* 295 */       if (digit < 0) {
/* 296 */         throw new NumberFormatException("Invalid number: " + value.substring(beginIndex, endIndex));
/*     */       }
/* 298 */       result = -digit;
/*     */     } 
/* 300 */     while (i < endIndex) {
/* 301 */       int digit = Character.digit(value.charAt(i++), 10);
/* 302 */       if (digit < 0) {
/* 303 */         throw new NumberFormatException("Invalid number: " + value.substring(beginIndex, endIndex));
/*     */       }
/* 305 */       result *= 10;
/* 306 */       result -= digit;
/*     */     } 
...
/* 315 */     for (int i = offset; i < string.length(); i++) {
/* 316 */       char c = string.charAt(i);
/* 317 */       if (c < '0' || c > '9') return i; 
/*     */     } 
/* 319 */     return string.length();
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/util/ISO8601Utils.class
