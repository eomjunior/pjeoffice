...
/* 134 */     for (int i = 0, end = this._hashArea.length; i < end; i += 2) {
/* 135 */       Object k2 = this._hashArea[i];
/* 136 */       if (k2 != null) {
/* 137 */         String s = (String)k2;
/* 138 */         if (s.equalsIgnoreCase(key)) {
/* 139 */           return this._hashArea[i + 1];
/*     */         }
/*     */       } 
/*     */     } 
/* 143 */     return null;
...
/* 147 */     int end = this._hashArea.length;
/* 148 */     List<String> keys = new ArrayList<>(end >> 2);
/* 149 */     for (int i = 0; i < end; i += 2) {
/* 150 */       Object key = this._hashArea[i];
/* 151 */       if (key != null) {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/util/CompactStringObjectMap.class
