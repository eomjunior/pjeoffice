...
/*  83 */     ClassIntrospector.MixInResolver overrides = (this._overrides == null) ? null : this._overrides.copy();
/*     */     
/*  85 */     Map<ClassKey, Class<?>> mixIns = (this._localMixIns == null) ? null : new HashMap<>(this._localMixIns);
...
/* 118 */     if (this._localMixIns == null) {
/*     */       
/* 120 */       if (this._overrides == null) {
/* 121 */         return false;
/*     */       }
/*     */       
/* 124 */       if (this._overrides instanceof SimpleMixInResolver) {
/* 125 */         return ((SimpleMixInResolver)this._overrides).hasMixIns();
/*     */       }
/*     */     } 
/*     */     
/* 129 */     return true;
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/introspect/SimpleMixInResolver.class
