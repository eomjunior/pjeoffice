...
/*     */     } else {
/* 205 */       properties = this._properties.<BeanPropertyWriter>toArray(new BeanPropertyWriter[this._properties.size()]);
...
/*     */             }));
/*     */     }
/* 220 */     return (JsonSerializer<?>)new BeanSerializer(this._beanDesc.getType(), this, properties, this._filteredProperties);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/ser/BeanSerializerBuilder.class
