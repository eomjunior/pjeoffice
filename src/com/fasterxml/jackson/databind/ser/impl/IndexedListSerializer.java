...
/*  70 */     if (len == 1 && ((
/*  71 */       this._unwrapSingle == null && provider
/*  72 */       .isEnabled(SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED)) || this._unwrapSingle == Boolean.TRUE)) {
/*     */       
...
/* 112 */               serializer = _findAndAddDynamic(serializers, provider
/* 113 */                   .constructSpecializedType(this._elementType, cc), provider);
/*     */             } else {
...
/* 174 */               serializer = _findAndAddDynamic(serializers, provider
/* 175 */                   .constructSpecializedType(this._elementType, cc), provider);
/*     */             } else {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/ser/impl/IndexedListSerializer.class
