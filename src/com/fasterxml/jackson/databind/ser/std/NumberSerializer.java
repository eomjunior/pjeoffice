...
/* 143 */         BigDecimal bd = (BigDecimal)value;
/*     */         
/* 145 */         if (!_verifyBigDecimalRange(gen, bd)) {
/*     */ 
/*     */           
/* 148 */           String errorMsg = String.format("Attempt to write plain `java.math.BigDecimal` (see JsonGenerator.Feature.WRITE_BIGDECIMAL_AS_PLAIN) with illegal scale (%d): needs to be between [-%d, %d]", new Object[] {
/*     */                 
/* 150 */                 Integer.valueOf(bd.scale()), Integer.valueOf(9999), Integer.valueOf(9999) });
/* 151 */           provider.reportMappingProblem(errorMsg, new Object[0]);
/*     */         } 
...
/* 169 */       return (scale >= -9999 && scale <= 9999);
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/ser/std/NumberSerializer.class
