...
/*  98 */     if (len == 1 && ((
/*  99 */       this._unwrapSingle == null && provider
/* 100 */       .isEnabled(SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED)) || this._unwrapSingle == Boolean.TRUE)) {
/*     */       
...
/* 137 */               serializer = _findAndAddDynamic(serializers, provider
/* 138 */                   .constructSpecializedType(this._elementType, cc), provider);
/*     */             } else {
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/databind/ser/std/CollectionSerializer.class
