...
/* 179 */     return (OutputStream)new DataOutputAsStream(out);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 200 */       String host = url.getHost();
/* 201 */       if (host == null || host.length() == 0) {
/*     */         
/* 203 */         String path = url.getPath();
/* 204 */         if (path.indexOf('%') < 0) {
/* 205 */           return new FileInputStream(url.getPath());
/*     */         }
/*     */       } 
/*     */     } 
/*     */ 
...
/* Location:              /home/oscar/Downloads/pjeoffice-pro-v2.5.16u-linux_x64/pjeoffice-pro/pjeoffice-pro.jar!/com/fasterxml/jackson/core/TokenStreamFactory.class
